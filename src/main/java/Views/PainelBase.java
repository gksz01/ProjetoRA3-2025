...
public abstract class PainelBase extends VBox {
    ...
    protected TextField horasAulaTextField;
    ...
    public PainelBase(String nomeEntidade, String emailEntidade, String idadeEntidade, int ctor){
        setSpacing(15);
        setPadding(new Insets(15));
        setStyle("-fx-background-color: #f4f4f4;");
        ...
        Label emailLabel = new Label(emailEntidade + ":");
        emailLabel.setStyle("-fx-font-size: 14px;");
        emailTextField = new TextField();
        emailTextField.setPromptText("Ex.: E-mail do " + nomeEntidade);

        Label idadeLabel = new Label(idadeEntidade + ":");
        idadeLabel.setStyle("-fx-font-size: 14px;");
        idadeTextField = new TextField();
        idadeTextField.setPromptText("Ex.: 16");

        inputGrid.add(nomeLabel, 0, 0);
        inputGrid.add(nomeTextField, 1, 0);
        inputGrid.add(emailLabel, 0, 1);
        inputGrid.add(emailTextField, 1, 1);
        inputGrid.add(idadeLabel, 0, 2);
        inputGrid.add(idadeTextField, 1, 2);
    ...
    public PainelBase(String nomeEntidade, String horasAula) {
        setSpacing(15);
        setPadding(new Insets(15));
        setStyle("-fx-background-color: #f4f4f4;");
        ...
        Label horasLabel = new Label(horasAula + ":");
        horasLabel.setStyle("-fx-font-size: 14px;");
        horasAulaTextField = new TextField();
        horasAulaTextField.setPromptText("Ex.: Horas Aula da " + nomeEntidade);


        inputGrid.add(nomeLabel, 0, 0);
        inputGrid.add(nomeTextField, 1, 0);
        inputGrid.add(horasLabel, 0, 1);
        inputGrid.add(horasAulaTextField, 1, 1);
